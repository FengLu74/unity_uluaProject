...
public abstract class UITweener : MonoBehaviour
{
    ...
    static public T Begin<T>(GameObject go, float duration, float delay = 0f, bool isClearFinishEvent = true) where T : UITweener
    {
        if (null == go)
            return null;
        ...
        if (isClearFinishEvent)
        {
            if (comp.onFinished != null)
