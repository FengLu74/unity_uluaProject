...
public class UIBasicSpriteWrap
{
	public static void Register(IntPtr L)
	{
		...
		LuaField[] fields = new LuaField[]
		{
			...
			new LuaField("radialCircleCenterPos", get_radialCircleCenterPos, set_radialCircleCenterPos),
			new LuaField("radialCircleRadius", get_radialCircleRadius, set_radialCircleRadius),
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_radialCircleCenterPos(IntPtr L)
	{
		object o = LuaScriptMgr.GetLuaObject(L, 1);
		UIBasicSprite obj = (UIBasicSprite)o;
		...
		if (obj == null)
		{
			...
			if (types == LuaTypes.LUA_TTABLE)
			{
				LuaDLL.luaL_error(L, "unknown member name radialCircleCenterPos");
			}
			else
			{
				LuaDLL.luaL_error(L, "attempt to index radialCircleCenterPos on a nil value");
			}
		}

		LuaScriptMgr.Push(L, obj.radialCircleCenterPos);
		return 1;
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_radialCircleRadius(IntPtr L)
	{
		object o = LuaScriptMgr.GetLuaObject(L, 1);
		UIBasicSprite obj = (UIBasicSprite)o;
		...
		if (obj == null)
		{
			...
			if (types == LuaTypes.LUA_TTABLE)
			{
				LuaDLL.luaL_error(L, "unknown member name radialCircleRadius");
			}
			else
			{
				LuaDLL.luaL_error(L, "attempt to index radialCircleRadius on a nil value");
			}
		}

		LuaScriptMgr.Push(L, obj.radialCircleRadius);
		return 1;
	}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int set_radialCircleCenterPos(IntPtr L)
	{
		object o = LuaScriptMgr.GetLuaObject(L, 1);
		UIBasicSprite obj = (UIBasicSprite)o;
		...
		obj.radialCircleCenterPos = LuaScriptMgr.GetVector2(L, 3);
		return 0;
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int set_radialCircleRadius(IntPtr L)
	{
		object o = LuaScriptMgr.GetLuaObject(L, 1);
		UIBasicSprite obj = (UIBasicSprite)o;
		...
		obj.radialCircleRadius = (int)LuaScriptMgr.GetNumber(L, 3);
		return 0;
	}
