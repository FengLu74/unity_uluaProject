...
public class UIRectWrap
{
	...
	static int SetAnchor(IntPtr L)
	{
		...
		else if (count == 6 && LuaScriptMgr.CheckTypes(L, 1, typeof(UIRect), typeof(GameObject), typeof(float), typeof(float), typeof(float), typeof(float)))
		{
			UIRect obj = (UIRect)LuaScriptMgr.GetUnityObjectSelf(L, 1, "UIRect");
			GameObject arg0 = (GameObject)LuaScriptMgr.GetLuaObject(L, 2);
		...
		else if (count == 6 && LuaScriptMgr.CheckTypes(L, 1, typeof(UIRect), typeof(GameObject), typeof(int), typeof(int), typeof(int), typeof(int)))
		{
			UIRect obj = (UIRect)LuaScriptMgr.GetUnityObjectSelf(L, 1, "UIRect");
			GameObject arg0 = (GameObject)LuaScriptMgr.GetLuaObject(L, 2);
