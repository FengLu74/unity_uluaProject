...
public class UICenterOnChildWrap
{
	public static void Register(IntPtr L)
	{
		...
		LuaField[] fields = new LuaField[]
		{
			...
			new LuaField("MoveRatio", get_MoveRatio, set_MoveRatio),
			new LuaField("isOpenMoveRatio", get_isOpenMoveRatio, set_isOpenMoveRatio),
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_MoveRatio(IntPtr L)
	{
		object o = LuaScriptMgr.GetLuaObject(L, 1);
		UICenterOnChild obj = (UICenterOnChild)o;
		...
		if (obj == null)
		{
			...
			if (types == LuaTypes.LUA_TTABLE)
			{
				LuaDLL.luaL_error(L, "unknown member name MoveRatio");
			}
			else
			{
				LuaDLL.luaL_error(L, "attempt to index MoveRatio on a nil value");
			}
		}

		LuaScriptMgr.Push(L, obj.MoveRatio);
		return 1;
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_isOpenMoveRatio(IntPtr L)
	{
		object o = LuaScriptMgr.GetLuaObject(L, 1);
		UICenterOnChild obj = (UICenterOnChild)o;
		...
		if (obj == null)
		{
			...
			if (types == LuaTypes.LUA_TTABLE)
			{
				LuaDLL.luaL_error(L, "unknown member name isOpenMoveRatio");
			}
			else
			{
				LuaDLL.luaL_error(L, "attempt to index isOpenMoveRatio on a nil value");
			}
		}

		LuaScriptMgr.Push(L, obj.isOpenMoveRatio);
		return 1;
	}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int set_MoveRatio(IntPtr L)
	{
		object o = LuaScriptMgr.GetLuaObject(L, 1);
		UICenterOnChild obj = (UICenterOnChild)o;
		...
		obj.MoveRatio = (float)LuaScriptMgr.GetNumber(L, 3);
		return 0;
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int set_isOpenMoveRatio(IntPtr L)
	{
		object o = LuaScriptMgr.GetLuaObject(L, 1);
		UICenterOnChild obj = (UICenterOnChild)o;
		...
		obj.isOpenMoveRatio = LuaScriptMgr.GetBoolean(L, 3);
		return 0;
	}
