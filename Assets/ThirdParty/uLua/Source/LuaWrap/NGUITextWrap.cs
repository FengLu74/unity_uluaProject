...
public class NGUITextWrap
{
	...
	static int GetExactCharacterIndex(IntPtr L)
	{
		LuaScriptMgr.CheckArgsCount(L, 3);
		List<Vector3> arg0 = (List<Vector3>)LuaScriptMgr.GetNetObject(L, 1, typeof(List<Vector3>));
		List<int> arg1 = (List<int>)LuaScriptMgr.GetNetObject(L, 2, typeof(List<int>));
	...
	static int Print(IntPtr L)
	{
		LuaScriptMgr.CheckArgsCount(L, 4);
		string arg0 = LuaScriptMgr.GetLuaString(L, 1);
		List<Vector3> arg1 = (List<Vector3>)LuaScriptMgr.GetNetObject(L, 2, typeof(List<Vector3>));
		List<Vector2> arg2 = (List<Vector2>)LuaScriptMgr.GetNetObject(L, 3, typeof(List<Vector2>));
		List<Color> arg3 = (List<Color>)LuaScriptMgr.GetNetObject(L, 4, typeof(List<Color>));
	...
	static int PrintApproximateCharacterPositions(IntPtr L)
	{
		...
		string arg0 = LuaScriptMgr.GetLuaString(L, 1);
		List<Vector3> arg1 = (List<Vector3>)LuaScriptMgr.GetNetObject(L, 2, typeof(List<Vector3>));
		List<int> arg2 = (List<int>)LuaScriptMgr.GetNetObject(L, 3, typeof(List<int>));
