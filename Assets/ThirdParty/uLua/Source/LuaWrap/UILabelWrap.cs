...
public class UILabelWrap
{
	public static void Register(IntPtr L)
	{
		LuaMethod[] regs = new LuaMethod[]
		{
			...
			new LuaMethod("GetUrlAtWorldPosition", GetUrlAtWorldPosition),
			new LuaMethod("GetUrlAtLocalPosition", GetUrlAtLocalPosition),
		...
		LuaField[] fields = new LuaField[]
		{
			...
			new LuaField("quadsPerCharacter", get_quadsPerCharacter, null),
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_quadsPerCharacter(IntPtr L)
	{
		object o = LuaScriptMgr.GetLuaObject(L, 1);
		UILabel obj = (UILabel)o;
		...
		if (obj == null)
		{
			...
			if (types == LuaTypes.LUA_TTABLE)
			{
				LuaDLL.luaL_error(L, "unknown member name quadsPerCharacter");
			}
			else
			{
				LuaDLL.luaL_error(L, "attempt to index quadsPerCharacter on a nil value");
			}
		}

		LuaScriptMgr.Push(L, obj.quadsPerCharacter);
		return 1;
	}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int GetUrlAtWorldPosition(IntPtr L)
	{
		LuaScriptMgr.CheckArgsCount(L, 2);
		UILabel obj = (UILabel)LuaScriptMgr.GetUnityObjectSelf(L, 1, "UILabel");
		Vector3 arg0 = LuaScriptMgr.GetVector3(L, 2);
		string o = obj.GetUrlAtWorldPosition(arg0);
		LuaScriptMgr.Push(L, o);
		return 1;
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int GetUrlAtLocalPosition(IntPtr L)
	{
		LuaScriptMgr.CheckArgsCount(L, 2);
		UILabel obj = (UILabel)LuaScriptMgr.GetUnityObjectSelf(L, 1, "UILabel");
		Vector2 arg0 = LuaScriptMgr.GetVector2(L, 2);
		string o = obj.GetUrlAtLocalPosition(arg0);
		LuaScriptMgr.Push(L, o);
		return 1;
	}
