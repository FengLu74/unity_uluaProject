...
public class UIWidgetWrap
{
	public static void Register(IntPtr L)
	{
		...
		LuaField[] fields = new LuaField[]
		{
			...
			new LuaField("brightnessAmount", get_brightnessAmount, set_brightnessAmount),
			new LuaField("saturationAmount", get_saturationAmount, set_saturationAmount),
			new LuaField("contrastAmount", get_contrastAmount, set_contrastAmount),
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_brightnessAmount(IntPtr L)
	{
		object o = LuaScriptMgr.GetLuaObject(L, 1);
		UIWidget obj = (UIWidget)o;
		...
		if (obj == null)
		{
			...
			if (types == LuaTypes.LUA_TTABLE)
			{
				LuaDLL.luaL_error(L, "unknown member name brightnessAmount");
			}
			else
			{
				LuaDLL.luaL_error(L, "attempt to index brightnessAmount on a nil value");
			}
		}

		LuaScriptMgr.Push(L, obj.brightnessAmount);
		return 1;
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_saturationAmount(IntPtr L)
	{
		object o = LuaScriptMgr.GetLuaObject(L, 1);
		UIWidget obj = (UIWidget)o;
		...
		if (obj == null)
		{
			...
			if (types == LuaTypes.LUA_TTABLE)
			{
				LuaDLL.luaL_error(L, "unknown member name saturationAmount");
			}
			else
			{
				LuaDLL.luaL_error(L, "attempt to index saturationAmount on a nil value");
			}
		}

		LuaScriptMgr.Push(L, obj.saturationAmount);
		return 1;
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_contrastAmount(IntPtr L)
	{
		object o = LuaScriptMgr.GetLuaObject(L, 1);
		UIWidget obj = (UIWidget)o;
		...
		if (obj == null)
		{
			...
			if (types == LuaTypes.LUA_TTABLE)
			{
				LuaDLL.luaL_error(L, "unknown member name contrastAmount");
			}
			else
			{
				LuaDLL.luaL_error(L, "attempt to index contrastAmount on a nil value");
			}
		}

		LuaScriptMgr.Push(L, obj.contrastAmount);
		return 1;
	}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int set_brightnessAmount(IntPtr L)
	{
		object o = LuaScriptMgr.GetLuaObject(L, 1);
		UIWidget obj = (UIWidget)o;
		...
		obj.brightnessAmount = (float)LuaScriptMgr.GetNumber(L, 3);
		return 0;
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int set_saturationAmount(IntPtr L)
	{
		object o = LuaScriptMgr.GetLuaObject(L, 1);
		UIWidget obj = (UIWidget)o;
		...
		obj.saturationAmount = (float)LuaScriptMgr.GetNumber(L, 3);
		return 0;
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int set_contrastAmount(IntPtr L)
	{
		object o = LuaScriptMgr.GetLuaObject(L, 1);
		UIWidget obj = (UIWidget)o;
		...
		obj.contrastAmount = (float)LuaScriptMgr.GetNumber(L, 3);
		return 0;
	}
	...
	static int WriteToBuffers(IntPtr L)
	{
		...
		List<Vector3> arg3 = (List<Vector3>)LuaScriptMgr.GetNetObject(L, 5, typeof(List<Vector3>));
		List<Vector4> arg4 = (List<Vector4>)LuaScriptMgr.GetNetObject(L, 6, typeof(List<Vector4>));
		List<Vector4> arg5 = (List<Vector4>)LuaScriptMgr.GetNetObject(L, 7, typeof(List<Vector4>));
		List<Vector4> arg6 = (List<Vector4>)LuaScriptMgr.GetNetObject(L, 8, typeof(List<Vector4>));
		obj.WriteToBuffers(arg0,arg1,arg2,arg3,arg4,arg5,arg6);
		return 0;
	}
