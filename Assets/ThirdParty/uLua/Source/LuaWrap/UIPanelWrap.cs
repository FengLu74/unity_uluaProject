...
public class UIPanelWrap
{
	public static void Register(IntPtr L)
	{
		...
		LuaField[] fields = new LuaField[]
		{
			...
			new LuaField("generateUV2", get_generateUV2, set_generateUV2),
			new LuaField("shadowMode", get_shadowMode, set_shadowMode),
			...
			new LuaField("onCreateMaterial", get_onCreateMaterial, set_onCreateMaterial),
			new LuaField("onCreateDrawCall", get_onCreateDrawCall, set_onCreateDrawCall),
			new LuaField("isGrayScale", get_isGrayScale, set_isGrayScale),
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_generateUV2(IntPtr L)
	{
		object o = LuaScriptMgr.GetLuaObject(L, 1);
		UIPanel obj = (UIPanel)o;
		...
		if (obj == null)
		{
			...
			if (types == LuaTypes.LUA_TTABLE)
			{
				LuaDLL.luaL_error(L, "unknown member name generateUV2");
			}
			else
			{
				LuaDLL.luaL_error(L, "attempt to index generateUV2 on a nil value");
			}
		}

		LuaScriptMgr.Push(L, obj.generateUV2);
		return 1;
	}
	...
	static int get_shadowMode(IntPtr L)
	{
		...
		if (obj == null)
		{
			...
			if (types == LuaTypes.LUA_TTABLE)
			{
				LuaDLL.luaL_error(L, "unknown member name shadowMode");
			}
			else
			{
				LuaDLL.luaL_error(L, "attempt to index shadowMode on a nil value");
			}
		}

		LuaScriptMgr.Push(L, obj.shadowMode);
		return 1;
	}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_onCreateMaterial(IntPtr L)
	{
		object o = LuaScriptMgr.GetLuaObject(L, 1);
		UIPanel obj = (UIPanel)o;
		...
		if (obj == null)
		{
			...
			if (types == LuaTypes.LUA_TTABLE)
			{
				LuaDLL.luaL_error(L, "unknown member name onCreateMaterial");
			}
			else
			{
				LuaDLL.luaL_error(L, "attempt to index onCreateMaterial on a nil value");
			}
		}

		LuaScriptMgr.Push(L, obj.onCreateMaterial);
		return 1;
	}
	...
	static int get_onCreateDrawCall(IntPtr L)
	{
		...
		if (obj == null)
		{
			...
			if (types == LuaTypes.LUA_TTABLE)
			{
				LuaDLL.luaL_error(L, "unknown member name onCreateDrawCall");
			}
			else
			{
				LuaDLL.luaL_error(L, "attempt to index onCreateDrawCall on a nil value");
			}
		}

		LuaScriptMgr.Push(L, obj.onCreateDrawCall);
		return 1;
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_isGrayScale(IntPtr L)
	{
		object o = LuaScriptMgr.GetLuaObject(L, 1);
		UIPanel obj = (UIPanel)o;
		...
		if (obj == null)
		{
			...
			if (types == LuaTypes.LUA_TTABLE)
			{
				LuaDLL.luaL_error(L, "unknown member name isGrayScale");
			}
			else
			{
				LuaDLL.luaL_error(L, "attempt to index isGrayScale on a nil value");
			}
		}

		LuaScriptMgr.Push(L, obj.isGrayScale);
		return 1;
	}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int set_generateUV2(IntPtr L)
	{
		object o = LuaScriptMgr.GetLuaObject(L, 1);
		UIPanel obj = (UIPanel)o;
		...
		obj.generateUV2 = LuaScriptMgr.GetBoolean(L, 3);
		return 0;
	}
	...
	static int set_shadowMode(IntPtr L)
	{
		...
		obj.shadowMode = (UIDrawCall.ShadowMode)LuaScriptMgr.GetNetObject(L, 3, typeof(UIDrawCall.ShadowMode));
		return 0;
	}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int set_onCreateMaterial(IntPtr L)
	{
		object o = LuaScriptMgr.GetLuaObject(L, 1);
		UIPanel obj = (UIPanel)o;
		...
		if (funcType != LuaTypes.LUA_TFUNCTION)
		{
			obj.onCreateMaterial = (UIPanel.OnCreateMaterial)LuaScriptMgr.GetNetObject(L, 3, typeof(UIPanel.OnCreateMaterial));
		}
		else
		{
			LuaFunction func = LuaScriptMgr.ToLuaFunction(L, 3);
			obj.onCreateMaterial = (param0, param1) =>
			{
				int top = func.BeginPCall();
				LuaScriptMgr.Push(L, param0);
	...
	static int set_onCreateDrawCall(IntPtr L)
	{
		...
		if (funcType != LuaTypes.LUA_TFUNCTION)
		{
			obj.onCreateDrawCall = (UIDrawCall.OnCreateDrawCall)LuaScriptMgr.GetNetObject(L, 3, typeof(UIDrawCall.OnCreateDrawCall));
		}
		else
		{
			LuaFunction func = LuaScriptMgr.ToLuaFunction(L, 3);
			obj.onCreateDrawCall = (param0, param1, param2) =>
			{
				int top = func.BeginPCall();
				LuaScriptMgr.Push(L, param0);
				LuaScriptMgr.Push(L, param1);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int set_isGrayScale(IntPtr L)
	{
		object o = LuaScriptMgr.GetLuaObject(L, 1);
		UIPanel obj = (UIPanel)o;
		...
		obj.isGrayScale = LuaScriptMgr.GetBoolean(L, 3);
		return 0;
	}
