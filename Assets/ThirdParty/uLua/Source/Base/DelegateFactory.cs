...
public static class DelegateFactory
{
	...
	public static void Register(IntPtr L)
	{
		...
		dict.Add(typeof(UICamera.GetMouseDelegate), new DelegateValue(UICamera_GetMouseDelegate));
		dict.Add(typeof(UICamera.GetTouchDelegate), new DelegateValue(UICamera_GetTouchDelegate));
		dict.Add(typeof(UICamera.RemoveTouchDelegate), new DelegateValue(UICamera_RemoveTouchDelegate));
		...
		dict.Add(typeof(UIPanel.OnCreateMaterial), new DelegateValue(UIPanel_OnCreateMaterial));
		dict.Add(typeof(UIDrawCall.OnCreateDrawCall), new DelegateValue(UIDrawCall_OnCreateDrawCall));
	...
	public static Delegate UICamera_GetMouseDelegate(LuaFunction func)
	{
		UICamera.GetMouseDelegate d = (param0) =>
		{
			int top = func.BeginPCall();
			IntPtr L = func.GetLuaState();
			LuaScriptMgr.Push(L, param0);
	...
	public static Delegate UICamera_RemoveTouchDelegate(LuaFunction func)
	{
		UICamera.RemoveTouchDelegate d = (param0) =>
		{
			int top = func.BeginPCall();
			IntPtr L = func.GetLuaState();
			LuaScriptMgr.Push(L, param0);
	...
	public static Delegate UIPanel_OnCreateMaterial(LuaFunction func)
	{
		UIPanel.OnCreateMaterial d = (param0, param1) =>
		{
			int top = func.BeginPCall();
			IntPtr L = func.GetLuaState();
			LuaScriptMgr.Push(L, param0);
