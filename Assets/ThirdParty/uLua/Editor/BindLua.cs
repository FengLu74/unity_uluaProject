...
public static class LuaBinding
{
    ...
    static void GenLuaBinder()
    {
        ...
        string[] files = Directory.GetFiles("Assets/ThirdParty/uLua/Source/LuaWrap/", "*.cs", SearchOption.TopDirectoryOnly);
        ...
        if (AppConst.AutoWrapMode) {
            string wrapfile = Application.dataPath + "/Lua/Utility/Wrap.lua";
